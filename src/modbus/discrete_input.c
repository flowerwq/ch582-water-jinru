...
#if APP_PID
static uint8_t mb_di_pr_cache[(MB_DI_ADDR_WIDS_MAX - MB_DI_ADDR_WIDS_BASE + 7)/8];
#endif

mb_di_ctx_t mb_di_list[] = {
//	{MB_DI_ADDR_BASE, MB_DI_ADDR_MAX - MB_DI_ADDR_BASE, mb_di_cache},
#if APP_PID
	{MB_DI_ADDR_WIDS_BASE,MB_DI_ADDR_WIDS_MAX-MB_DI_ADDR_WIDS_BASE,mb_di_pr_cache},
